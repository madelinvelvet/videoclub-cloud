...
const PELICULAS_INICIALES = [
  { 
    ...
    poster: 'https://image.tmdb.org/t/p/w500/v9Q7bRNrHU695wUj6v9u6p6vU4B.jpg',
  ...
  { 
    ...
    titulo: 'Interstellar', 
    genero: 'Sci-Fi / Drama', 
    poster: 'https://image.tmdb.org/t/p/w500/gEU2vYvws7I7g0vdb67jA6wUvOm.jpg',
  ...
  { 
    ...
    poster: 'https://image.tmdb.org/t/p/w500/b0Mxv3g4g6wEgXgTIgXnnHFSZ6O.jpg',
  ...
  { 
    ...
    titulo: 'El Conjuro', 
    genero: 'Terror', 
    poster: 'https://image.tmdb.org/t/p/w500/409C6L8n91qIsc0p3b4UfT3N0mY.jpg',
...
export default async function Home() {
  ...
  if (!peliculas) {
    // Ahora 'alquiladaPor' empieza como un array vacío []
    ...
    <main className="min-h-screen bg-slate-900 text-slate-100 p-8">
      <div className="max-w-5xl mx-auto">
        <header className="mb-12 text-center">
          <h1 className="text-4xl font-extrabold text-indigo-400 mb-2">🍿 Vercel VideoClub Premium</h1>
          <p className="text-slate-400">Alquila tus películas favoritas en la nube</p>
        </header>
